...
export default function ScrollContainer() {
  return (
    <section className="w-full  bg-custom-bg pt-4">
      <main className="w-full h-full flex flex-col items-center gap-4">
        <div className="w-2/3 h-full flex flex-col  p-4">
          <h1 className="text-custom-primary text-4xl font-bold ">Features</h1>
          ...
          <div className="flex flex-col items-center justify-center gap-4 px-20 ">
            <Card
              title="News"
              description="Get the latest news about your favorite stocks."
              icon={icons.news}
              index={0}
            />
            <Card
